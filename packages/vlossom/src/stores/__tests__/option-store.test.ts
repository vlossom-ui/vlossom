...
describe('option store', () => {
    ...
    describe('styleSets', () => {
        describe('registerStyleSet', () => {
            ...
            it('여러 컴포넌트의 styleSet을 한 번에 등록할 수 있다', () => {
                // given
                const store = new OptionStore();
                const styleSet = {
                    VsButton: {
        ...
        describe('getStyleSet', () => {
            ...
            it('존재하지 않는 컴포넌트의 StyleSet을 조회하면 undefined를 반환한다', () => {
                // given
                const store = new OptionStore();
                const styleSet = {
                    VsButton: {
                ...
                // when
                const result = store.getStyleSet('NonExistentComponent', 'primary');
    ...
    describe('globalRadiusRatio', () => {
        it('globalRadiusRatio를 설정할 수 있다', () => {
            ...
            const setPropertySpy = vi
                .spyOn((document.querySelector(':root') as HTMLElement).style, 'setProperty')
                .mockImplementation(() => {});
        ...
        it('globalRadiusRatio가 0이면 정상적으로 설정된다', () => {
            // given
            const store = new OptionStore();
            const setPropertySpy = vi
                .spyOn((document.querySelector(':root') as HTMLElement).style, 'setProperty')
        ...
        it('globalRadiusRatio가 1이면 정상적으로 설정된다', () => {
            // given
            const store = new OptionStore();
            const setPropertySpy = vi
                .spyOn((document.querySelector(':root') as HTMLElement).style, 'setProperty')
