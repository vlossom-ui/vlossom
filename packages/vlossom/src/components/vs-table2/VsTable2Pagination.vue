...
import type { VsTable2PageSizeOptions, VsTable2PaginationOptions, VsTable2StyleSet } from './types';
...
export default defineComponent({
    ...
    props: {
        options: { type: Object as PropType<VsTable2PaginationOptions>, default: () => ({}) },
    ...
    setup(props) {
        ...
        const pageSizeOptions = computed<VsTable2PageSizeOptions>(() => options.value.pageSizeOptions ?? []);
