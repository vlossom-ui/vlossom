...
| `styleSet`      | `string \| VsTable2StyleSet`                   |          | Custom style set for the component                                                                                                        |
| `columns`       | `VsTable2ColumnDef[] \| string[]`              | `[]`     | Column definitions. Falls back to the first item's keys when empty                                                                        |
| `items`         | `VsTable2Item[]`                               | `[]`     | Data rows. Never mutated by the table                                                                                                     |
...
| `loading`       | `boolean`                                      | `false`  | Shows loading state and disables search, pagination, and dragging                                                                         |
...
| `pagedItems`    | `VsTable2Item[]`                               | `[]`     | Rows on the current page, v-model (output only)                                                                                           |
| `pagination`    | `boolean \| VsTable2PaginationOptions`         | `false`  | Enables pagination                                                                                                                        |
| `primary`       | `boolean`                                      | `false`  | Applies primary color to the header                                                                                                       |
| `responsive`    | `boolean`                                      | `false`  | Enables responsive (stacked) layout                                                                                                       |
| `search`        | `boolean \| VsTable2SearchOptions`             | `false`  | Enables built-in search                                                                                                                   |
| `selectable`    | `boolean \| (item, index?, items?) => boolean` | `false`  | Enables row selection                                                                                                                     |
| `selectedItems` | `VsTable2Item[]`                               | `[]`     | Selected rows, v-model                                                                                                                    |
...
| `totalItems`    | `VsTable2Item[]`                               | `[]`     | All rows in display order after search and sorting, v-model (output only)                                                                 |
...
| ---------------------- | --------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `click-cell`           | `(cell: VsTable2Cell, event: MouseEvent)`                                   | Emitted when a body cell is clicked                                                |
| `click-row`            | `(item: VsTable2Item, index: number, event: MouseEvent)`                    | Emitted when a body row is clicked                                                 |
| `select-row`           | `(item: VsTable2Item, index: number, selected: boolean, event: MouseEvent)` | Emitted when a row is selected or unselected                                       |
| `expand-row`           | `(item: VsTable2Item, index: number, expanded: boolean, event: MouseEvent)` | Emitted when a row is expanded or collapsed                                        |
| `drag`                 | `SortableEvent`                                                             | Emitted after a drag-and-drop reorder                                              |
| `search`               | `(items: VsTable2Item[], searchText: string)`                               | Emitted on search, with the rows shown after filtering                             |
...
| `update:selectedItems` | `VsTable2Item[]`                                                            | Emitted when selected rows change                                                  |
| `update:page`          | `number`                                                                    | Emitted when the current page changes                                              |
| `update:pageSize`      | `number`                                                                    | Emitted when the page size changes                                                 |
| `update:pagedItems`    | `VsTable2Item[]`                                                            | Emitted when the rows on the current page change                                   |
| `update:totalItems`    | `VsTable2Item[]`                                                            | Emitted when the rows after search and sorting change                              |
...
| `header-[key]` | `{ item: VsTable2ColumnDef, value, colIdx, rowIdx }` | Custom header cell for a specific column key                                    |
| `item-[key]`   | `{ item: VsTable2Item, value, colIdx, rowIdx }`      | Custom item cell for a specific column key                                      |
| `select`       | `{ item, value, rowIdx }`                            | Custom content for the selection column cell                                    |
