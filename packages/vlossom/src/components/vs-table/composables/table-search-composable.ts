...
import type { VsTableColumnDef, VsTableItem, VsTableSearchOptions } from './../types';
...
export function useTableSearchComposable(
    ...
    rawSearch: Ref<boolean | VsTableSearchOptions>,
    columns: ComputedRef<VsTableColumnDef[]>,
    ...
    function getItemSearchText(item: VsTableItem): string {
