...
- • Base values should be in baseStyleSet, not additionalStyleSet
- • Improves separation of default vs. user-provided styles
...
**Keywords:** style, basestyleset, default-styles, style-separation, computed-styles, style-layering
