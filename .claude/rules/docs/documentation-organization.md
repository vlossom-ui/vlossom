...
- • Create separate 'guidelines' directory for documentation organization
- • Consolidate similar guideline documents in centralized location
...
**Keywords:** documentation, guide, 가이드, directory-structure, documentation-organization, style-set-system, developer-guidelines
